...
public class CodeGenerator {
	// JDBC配置，请修改为你项目的实际配置
	private static final String JDBC_URL = "jdbc:mysql://197.3.155.17:3326/oadsp";
	private static final String JDBC_USERNAME = "xw";
